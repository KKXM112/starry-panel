...
const envTableDensityStorageKey = 'starry-env-table-density'
// 值的遮蔽模式（#127），和上面的表格密度是同一类只存本机的偏好，键名沿用本页 starry-env-* 前缀。
// （每页条数原来也在这一类，v3.3.1 起改为跟随账户，读写统一走 utils/listPreferences.ts。）
const envMaskModeStorageKey = 'starry-env-mask-mode'
