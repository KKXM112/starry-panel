...
const starryWindow = window as Window & {
  __STARRY_SAFE_FOCUS_PATCHED__?: boolean;
};

if (!starryWindow.__STARRY_SAFE_FOCUS_PATCHED__) {
  starryWindow.__STARRY_SAFE_FOCUS_PATCHED__ = true;
