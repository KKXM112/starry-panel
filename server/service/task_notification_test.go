...
func TestSummarizeTaskFailureOutputCondensesPythonTraceback(t *testing.T) {
	output := strings.Join([]string{
		...
		"    ^^^^^^^^^^^^^^^^^^^^^^^",
		`  File "/app/Starry-Panel/scripts/电信营业厅/电信.py", line 1118, in main`,
...
func TestBuildModuleCompatibilityHintRecognizesRequireEsmFailure(t *testing.T) {
	output := strings.Join([]string{
		...
		"                       ^",
		"Error [ERR_REQUIRE_ESM]: require() of ES Module /app/Starry-Panel/deps/nodejs/node_modules/uuid/dist-node/index.js from /app/Starry-Panel/scripts/wc.js not supported.",
		"Instead change the require of index.js in /app/Starry-Panel/scripts/wc.js to a dynamic import() which is available in all CommonJS modules.",
	}, "\n")
...
func TestBuildModuleCompatibilityHintReportsUnmappedRequireEsmPackage(t *testing.T) {
	output := strings.Join([]string{
		...
		"Error [ERR_REQUIRE_ESM]: require() of ES Module /app/Starry-Panel/deps/nodejs/node_modules/some-esm-only-package/index.js from /app/Starry-Panel/scripts/demo.js not supported.",
		"Instead change the require of index.js in /app/Starry-Panel/scripts/demo.js to a dynamic import() which is available in all CommonJS modules.",
	}, "\n")
