	...
	manifest := BackupManifest{
		...
		Data: BackupPayload{
			...
			Dependencies: []BackupDependency{
				{Type: model.DepTypePython, Name: "starry-restore-mirror-test-package"},
			},
		},
	}
...
func TestRestoreScriptFilesKeepsLiveDataWhenStageCopyFails(t *testing.T) {
	...
	err := restoreScriptFiles(extractedDir, "starry-panel")
...
func TestRestoreLogFilesKeepsLivePanelLogWhenStageCopyFails(t *testing.T) {
	...
	err := restoreLogFiles(extractedDir, "starry-panel")
