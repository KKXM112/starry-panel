...
const defaultAndroidRuntimeBinDir = "/data/adb/starry-panel/bin"
...
func androidSupported() bool {
	...
	if _, err := os.Stat("/data/adb/modules/starry-panel"); err == nil {
		return true
	}
	return false
}
...
func resolveAndroidRuntimeBinDir() string {
	if dir := strings.TrimSpace(os.Getenv("STARRY_ANDROID_RUNTIME_BIN_DIR")); dir != "" {
		return dir
	}
