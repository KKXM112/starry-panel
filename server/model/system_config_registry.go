...
import (
	...
	panelcron "starry-panel/pkg/cron"
	"starry-panel/pkg/netutil"
)
...
var registeredSystemConfigSpecs = finalizeSystemConfigSpecs([]systemConfigSpec{
	...
	newValidatedStringConfig("update_image_mirror", "系统更新镜像源", "", "旧 Docker Socket 更新链路使用的可选镜像源（Watchtower 部署请通过 STARRY_PANEL_IMAGE 配置仓库）", "network", normalizeUpdateImageMirror),
	...
	newTrimmedStringConfig("panel_title", "面板标题", "满天星面板", "面板标题", "branding"),
	...
	newTrimmedStringConfig("panel_service_name", "systemd 服务名", "starry-panel", "systemd 服务名称", "branding"),
